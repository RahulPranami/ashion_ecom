                ...
                <div class="row">
                    <?php while ($product = $products->fetch_assoc()) : ?>
                        ...
                        <!-- <tr>
                            ...
                            <td></td>
                            <td><?= $product['cName'] ?></td>
                            <td> <img style="width: 50px; height: 50px;" src="<?= $product['image']; ?>" alt="Not Found"> </td>
                            <td><?= $product['description'] ?></td>
                            <td><?= $product['price'] ?></td>
                            <td><a href="?dashboard&editProd=<?= $product['id'] ?>"> <button class="btn btn-sm btn-outline-success">Edit</button> </a> </td>
                            <td><button name="btnDel" class="btn btn-sm btn-outline-danger" onclick="deleteData('<?= $product['id'] ?>')">Delete</button></td>
                        </tr> -->
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?= "img/shop/shop-1.jpg" ?? $product['image'] ?? "img/shop/shop-1.jpg" ?>">
                                    ...
                                    <ul class="product__hover">
                                        <li><a href="#" data-toggle="modal" data-target="#productModal" data-productname="Furry" data-productprice="$ 59.0"><span class="arrow_expand"></span></a></li>
                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                        <!-- <li><a href="javascript:void(0);" onclick="addToCart('<?= $product['id'] ?>')"><span class="icon_bag_alt"></span></a></li> -->
                                        <li><a href="#" onclick="addToCart('<?= $product['id'] ?>','add')"><span class="icon_bag_alt"></span></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    ...
                                    <div class="product__price">$ <?= $product['price'] ?? '59.0' ?></div>
                                </div>
                            </div>
                        </div>
                    <?php endwhile ?>
