                        ...
                        <div class="card-body py-5 px-md-5">
                            ...
                            <form method="post" id="signup">
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="nameErr" class="text-danger text-left errorTxt" aria-live="polite"></small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="emailErr" class="text-danger text-left errorTxt" aria-live="polite"></small>
                                </div>
