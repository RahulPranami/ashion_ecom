    ...
    <div class="container">
        ...
        <div class="row property__gallery">
            ...
            <?php while ($product = $products->fetch_assoc()) : ?>
                <div class="col-lg-4 col-md-6 col-sm-6 mix <?= $product['cName'] ?>">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix t-shirt">
                <div class="product__item">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix formals">
                <div class="product__item">
