                        ...
                        <tbody id="tBody">
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td><button class="btn btn-sm btn-outline-danger delete-btn" id="<?= $row['id'] ?>">Delete</button></td>
                                    <!-- <td><a href="./deleteProduct.php?id=<?= $row['id']; ?>"> <button class="btn btn-sm btn-outline-primary">Active</button> </a> </td> -->
                                </tr>
                            <?php endwhile ?>
                        </tbody>
                    </table>
