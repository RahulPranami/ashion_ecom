...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item <?= ($cURL == "products" || $cURL == "addProduct" || $cURL == "updateProduct") ? 'active' : ''; ?>">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item <?= ($cURL == "categories" || $cURL == "addCategory" || $cURL == "updateCategory") ? 'active' : ''; ?>">
