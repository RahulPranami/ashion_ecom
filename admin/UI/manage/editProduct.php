<?php $user = $ecomm->getProductDetails($_GET['id']); ?>

<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit a Product</h1>
    ...
    <div class="bootstrap snippets bootdey">
        <div class="row">
            <div class="container col-md-12 personal-info">
                ...
                <!-- <form> -->
                <form class="form-horizontal" role="form" id="editProd" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="product" name="product" value="<?= $user['id'] ?>" />
                        ...
                        <div class="col-lg-8">
                            ...
                            <select name="categoryId" id="categoryId" class="form-control" data-error="#catErr">
                                ...
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <option value="<?= $row['id'] ?>" <?= $row['id'] == $user['categoryId'] ? "selected" : "" ?>><?= $row['name'] ?></option>
                                <?php endwhile ?>
                            </select>
                        </div>
                    ...
                    <div class="form-outline mb-3">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="price" name="price" class="form-control" value="<?= $user['price'] ?>" />
                        </div>
                    </div>

                    <div class="form-outline mb-3">
                        <label class="form-label col-lg-3" for="stock">Product Stock:</label>
                        <div class="col-lg-8">
                            <input type="number" id="stock" name="stock" class="form-control" value="<?= $user['quantity'] ?>" />
                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary ml-4 mb-4" id="edit-prod-btn"> Update Product </button>
                </form>
            </div>
        </div>
    </div>
